...
public class YusufteDiamondRenderer extends MobRenderer<YusufteDiamondEntity, PlayerModel<YusufteDiamondEntity>> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(AphernixMod.MOD_ID, "textures/entity/yusufte_diamond.png");

    public YusufteDiamondRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    public void render(YusufteDiamondEntity entity, float entityYaw, float partialTicks,
    ...
    @Override
    public ResourceLocation getTextureLocation(YusufteDiamondEntity entity) {
        return TEXTURE;
    }
}
