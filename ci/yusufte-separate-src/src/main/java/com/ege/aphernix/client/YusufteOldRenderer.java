...
public class YusufteOldRenderer extends MobRenderer<YusufteOldEntity, PlayerModel<YusufteOldEntity>> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(AphernixMod.MOD_ID, "textures/entity/yusufte_old.png");

    public YusufteOldRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    public void render(YusufteOldEntity entity, float entityYaw, float partialTicks,
    ...
    @Override
    public ResourceLocation getTextureLocation(YusufteOldEntity entity) {
        return TEXTURE;
    }
}
